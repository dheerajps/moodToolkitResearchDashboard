...
select patient, COUNT(*) as totalSurveys from alcoholStudy where patient in (select Distinct patient from alcoholStudy) and (type1 != "Sensor connection" AND type1 != "")  group by patient;